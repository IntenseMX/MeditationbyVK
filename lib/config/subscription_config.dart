...
class SubscriptionConfig {
  ...
  /// Prevents "billing API not supportedNo more terminals" spam when stores aren't configured.
  /// Set to true when ready to test with App Store/Play Store.
  static const bool enableIAP = true; // TODO: Set to true before production testing
